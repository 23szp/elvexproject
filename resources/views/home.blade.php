...
>
    ...
    <div class="absolute inset-0">
        <div class="container h-full mx-auto px-4 flex items-center">
            <div class="bg-white p-3 sm:p-4 md:p-6 rounded-lg shadow-lg max-w-[250px] sm:max-w-xs">
                <h3 class="text-base sm:text-lg md:text-xl font-bold mb-2">
                    Készen állsz ruhatárad szortírozására?
                </h3>
                <a
                    href="{{ route('products.create') }}"
                    class="block w-full bg-gradient-to-r from-purple-500 to-purple-700 text-white text-center py-2 px-3 sm:px-4 rounded-md hover:from-purple-600 hover:to-purple-800 transition mb-2 text-sm sm:text-base"
                >
                    Eladás most
                </a>
                <a
                    href="{{ route('sugo') }}"
                    class="text-purple-600 text-xs sm:text-sm hover:underline"
                >
                    Tudd meg, hogyan működik
                </a>
            </div>
        </div>
    </div>
...
<div class="mb-12">
    ...
    <div class="mb-12 relative rounded-xl overflow-hidden shadow-lg">
        <img 
            src="{{ asset('images/electronics.jpg') }}" 
            alt="Elektronikai termékek" 
            class="w-full h-72 object-cover bg-teal-800"
        />
        <div class="absolute inset-0 bg-gradient-to-r from-teal-900 to-transparent flex items-center">
            <div class="px-8 max-w-md">
                <h3 class="text-white text-2xl font-bold mb-3">Árulj elektronikai termékeket díjmentesen</h3>
                <p class="text-teal-100 mb-4">Szabadulj meg a nem használt eszközeidtől és keress vele pénzt egyszerűen.</p>
                <a href="{{ route('products.create') }}" class="inline-block bg-white text-teal-800 py-3 px-6 rounded-md hover:bg-gray-100 transition duration-300 font-medium">Keress pénzt most</a>
            </div>
        </div>
    </div>
