...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
    <h2 class="text-2xl font-semibold mb-6">Elfelejtett jelszó</h2>
    ...
    <p class="mb-4 text-gray-600">Add meg az email címed, és küldünk egy linket a jelszavad visszaállításához.</p>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <button class="w-full bg-purple-600 hover:bg-purple-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                type="submit">Jelszó-visszaállító link küldése</button>
    </form>
